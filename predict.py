...
with model.as_default():
    with tf.Session(graph=model) as sess:
        ...
        # Verifica para ver se nós deveríamos redimensionar junto a comprimento
        if W > H and W > 1000:
        ...
        # multidimensionais, então as comprimimos em uma matriz 1D, permitindo
        # que passemos facilmente sobre elas.
